...
def _client_with_fakes(
    ...
    http_app._processor = fake_processor  # pylint: disable=protected-access
    http_app._config = object()  # pylint: disable=protected-access
    ...
    try:
        ...
        client.close()
        http_app._processor = None  # pylint: disable=protected-access
        http_app._config = None  # pylint: disable=protected-access
