...
function [overlap, normoverlap] = rectintC(A,B)  % 详解: 函数定义：rectintC(A,B), 返回：overlap, normoverlap
...
[overlap, normoverlap] = rectintLoopC(leftA, rightA, topA, bottomA, leftB, rightB, topB, bottomB, verbose);  % 详解: 执行语句
